...
import otherpackages.org.zeromq.ZMQException;

public class MapZmq {
    // Debugging
    private static final String TAG = "MapZmq";
    ...
    public static MapZmq getInstance(Handler handler) {
...
*/
    ...
    private class SubscriberThread extends Thread {
        ...
        public void run() {
            ...
            try {
                subscriber.connect(NetConfig.MAP_URL);
