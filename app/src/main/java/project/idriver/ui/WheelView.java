...
//                    Log.d(TAG, "remainder: " + remainder + ", divided: " + divided);
    ...
    private TextView createView(String item) {
        ...
        tv.setTextSize(TypedValue.COMPLEX_UNIT_SP, 24); //tv.setTextSize(TypedValue.COMPLEX_UNIT_SP, 20);    //wjr
        tv.setText(item);
        tv.setGravity(Gravity.CENTER);
        int ud_padding = dip2px(0); // int padding = dip2px(15); //wjr
        int lr_padding = dip2px(30); //wjr
        tv.setPadding(lr_padding, ud_padding, lr_padding, ud_padding); //tv.setPadding(padding, padding, padding, padding); //wjr
        if (0 == itemHeight) {
            itemHeight = getViewMeasuredHeight(tv);
            Log.d(TAG, "canvas itemHeight: " + itemHeight);
