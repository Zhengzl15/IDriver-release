...
package otherpackages.org.zeromq;
...
import otherpackages.zmq.Ctx;
import otherpackages.zmq.DecoderBase;
import otherpackages.zmq.EncoderBase;
import otherpackages.zmq.SocketBase;
import otherpackages.zmq.ZError;
import otherpackages.zmq.ZError.CtxTerminatedException;
...
public class ZMQ
{
     ...
     */
    public static final int SNDMORE = otherpackages.zmq.ZMQ.ZMQ_SNDMORE;

    // Values for flags in Socket's send and recv functions.
    /**
     * Socket flag to indicate a nonblocking send or recv mode.
     */
    public static final int DONTWAIT = otherpackages.zmq.ZMQ.ZMQ_DONTWAIT;
    public static final int NOBLOCK = otherpackages.zmq.ZMQ.ZMQ_DONTWAIT;

    // Socket types, used when creating a Socket.
    /**
     * Flag to specify a exclusive pair of sockets.
     */
    public static final int PAIR = otherpackages.zmq.ZMQ.ZMQ_PAIR;
    /**
     * Flag to specify a PUB socket, receiving side must be a SUB or XSUB.
     */
    public static final int PUB = otherpackages.zmq.ZMQ.ZMQ_PUB;
    /**
     * Flag to specify the receiving part of the PUB or XPUB socket.
     */
    public static final int SUB = otherpackages.zmq.ZMQ.ZMQ_SUB;
    /**
     * Flag to specify a REQ socket, receiving side must be a REP.
     */
    public static final int REQ = otherpackages.zmq.ZMQ.ZMQ_REQ;
    /**
     * Flag to specify the receiving part of a REQ socket.
     */
    public static final int REP = otherpackages.zmq.ZMQ.ZMQ_REP;
    /**
     ...
     */
    public static final int DEALER = otherpackages.zmq.ZMQ.ZMQ_DEALER;
    /**
    ...
    */
     ...
     */
    public static final int ROUTER = otherpackages.zmq.ZMQ.ZMQ_ROUTER;
    /**
     ...
     */
    public static final int PULL = otherpackages.zmq.ZMQ.ZMQ_PULL;
    /**
     * Flag to specify a PUSH socket, receiving side must be a PULL.
     */
    public static final int PUSH = otherpackages.zmq.ZMQ.ZMQ_PUSH;
    /**
     ...
     */
    public static final int XPUB = otherpackages.zmq.ZMQ.ZMQ_XPUB;
    /**
     * Flag to specify the receiving part of the PUB or XPUB socket. Allows
     */
    public static final int XSUB = otherpackages.zmq.ZMQ.ZMQ_XSUB;

    /**
     * Flag to specify a STREAMER device.
     */
    public static final int STREAMER = otherpackages.zmq.ZMQ.ZMQ_STREAMER;
    /**
     * Flag to specify a FORWARDER device.
     */
    public static final int FORWARDER = otherpackages.zmq.ZMQ.ZMQ_FORWARDER;
    /**
     * Flag to specify a QUEUE device.
     */
    public static final int QUEUE = otherpackages.zmq.ZMQ.ZMQ_QUEUE;
     ...
     */
    public static final int EVENT_CONNECTED = otherpackages.zmq.ZMQ.ZMQ_EVENT_CONNECTED;
    /**
     ...
     * no meaning.
     */
    public static final int EVENT_CONNECT_DELAYED = otherpackages.zmq.ZMQ.ZMQ_EVENT_CONNECT_DELAYED;
     ...
     */
    public static final int EVENT_CONNECT_RETRIED = otherpackages.zmq.ZMQ.ZMQ_EVENT_CONNECT_RETRIED;
     ...
     */
    public static final int EVENT_LISTENING = otherpackages.zmq.ZMQ.ZMQ_EVENT_LISTENING;
    /**
     ...
     */
    public static final int EVENT_BIND_FAILED = otherpackages.zmq.ZMQ.ZMQ_EVENT_BIND_FAILED;
     ...
     * the accepted socket.
     */
    public static final int EVENT_ACCEPTED = otherpackages.zmq.ZMQ.ZMQ_EVENT_ACCEPTED;
    /**
     ...
     */
    public static final int EVENT_ACCEPT_FAILED = otherpackages.zmq.ZMQ.ZMQ_EVENT_ACCEPT_FAILED;
     ...
     */
    public static final int EVENT_CLOSED = otherpackages.zmq.ZMQ.ZMQ_EVENT_CLOSED;
    /**
     ...
     */
    public static final int EVENT_CLOSE_FAILED = otherpackages.zmq.ZMQ.ZMQ_EVENT_CLOSE_FAILED;
    /**
     ...
     * the socket.
     */
    public static final int EVENT_DISCONNECTED = otherpackages.zmq.ZMQ.ZMQ_EVENT_DISCONNECTED;
    /**
     * EVENT_MONITOR_STOPPED: monitor has been stopped.
     * The EVENT_MONITOR_STOPPED event triggers when the monitor for a socket is
     * stopped.
     */
    public static final int EVENT_MONITOR_STOPPED = otherpackages.zmq.ZMQ.ZMQ_EVENT_MONITOR_STOPPED;

    /**
     * EVENT_ALL: all events known.
     * The EVENT_ALL constant can be used to set up a monitor for all known events.
     */
    public static final int EVENT_ALL = otherpackages.zmq.ZMQ.ZMQ_EVENT_ALL;
    ...
    public static class Context implements Closeable
    {
        ...
        {
            ctx = otherpackages.zmq.ZMQ.init(ioThreads);
        }
        ...
        {
            return ctx.get(otherpackages.zmq.ZMQ.ZMQ_IO_THREADS);
        }
        ...
        {
            return ctx.set(otherpackages.zmq.ZMQ.ZMQ_IO_THREADS, ioThreads);
        }
        ...
        {
            return ctx.get(otherpackages.zmq.ZMQ.ZMQ_MAX_SOCKETS);
        }
        ...
        {
            return ctx.set(otherpackages.zmq.ZMQ.ZMQ_MAX_SOCKETS, maxSockets);
        }

        public boolean getBlocky()
        {
            return ctx.get(otherpackages.zmq.ZMQ.ZMQ_BLOCKY) != 0;
        }

        public boolean setBlocky(boolean block)
        {
            return ctx.set(otherpackages.zmq.ZMQ.ZMQ_BLOCKY, block ? 1 : 0);
        }
    ...
    public static class Socket implements Closeable
    {
        ...
        {
            return base.getSocketOpt(otherpackages.zmq.ZMQ.ZMQ_TYPE);
        }
        ...
        {
            return base.getSocketOpt(otherpackages.zmq.ZMQ.ZMQ_LINGER);
        }
        ...
        {
            base.setSocketOpt(otherpackages.zmq.ZMQ.ZMQ_LINGER, (int) value);
        }
        ...
        {
            return base.getSocketOpt(otherpackages.zmq.ZMQ.ZMQ_RECONNECT_IVL);
        }
        ...
        {
            base.setSocketOpt(otherpackages.zmq.ZMQ.ZMQ_RECONNECT_IVL, (int) value);
        }
        ...
        {
            return base.getSocketOpt(otherpackages.zmq.ZMQ.ZMQ_BACKLOG);
        }
        ...
        {
            setsockopt(otherpackages.zmq.ZMQ.ZMQ_BACKLOG, (int) value);
        }
        ...
        {
            return base.getSocketOpt(otherpackages.zmq.ZMQ.ZMQ_RECONNECT_IVL_MAX);
        }
        ...
        {
            setsockopt(otherpackages.zmq.ZMQ.ZMQ_RECONNECT_IVL_MAX, (int) value);
        }
        ...
        {
            return (Long) base.getsockoptx(otherpackages.zmq.ZMQ.ZMQ_MAXMSGSIZE);
        }
        ...
        {
            setsockopt(otherpackages.zmq.ZMQ.ZMQ_MAXMSGSIZE, value);
        }
        ...
        {
            return base.getSocketOpt(otherpackages.zmq.ZMQ.ZMQ_SNDHWM);
        }
        ...
        {
            setsockopt(otherpackages.zmq.ZMQ.ZMQ_SNDHWM, (int) value);
        }
        ...
        {
            return base.getSocketOpt(otherpackages.zmq.ZMQ.ZMQ_RCVHWM);
        }
        ...
        {
            setsockopt(otherpackages.zmq.ZMQ.ZMQ_RCVHWM, (int) value);
        }
        ...
        {
            return (Long) base.getsockoptx(otherpackages.zmq.ZMQ.ZMQ_AFFINITY);
        }
        ...
        {
            setsockopt(otherpackages.zmq.ZMQ.ZMQ_AFFINITY, value);
        }
        ...
        {
            return (byte[]) base.getsockoptx(otherpackages.zmq.ZMQ.ZMQ_IDENTITY);
        }
        ...
        {
            setsockopt(otherpackages.zmq.ZMQ.ZMQ_IDENTITY, identity);
        }
        ...
        {
            return base.getSocketOpt(otherpackages.zmq.ZMQ.ZMQ_RATE);
        }
        ...
        {
            return base.getSocketOpt(otherpackages.zmq.ZMQ.ZMQ_RECOVERY_IVL);
        }
        ...
        {
            return base.getSocketOpt(otherpackages.zmq.ZMQ.ZMQ_MULTICAST_HOPS);
        }
        ...
        {
            return base.getSocketOpt(otherpackages.zmq.ZMQ.ZMQ_RCVTIMEO);
        }
        ...
        {
            setsockopt(otherpackages.zmq.ZMQ.ZMQ_RCVTIMEO, value);
        }
        ...
        {
            return base.getSocketOpt(otherpackages.zmq.ZMQ.ZMQ_SNDTIMEO);
        }
        ...
        {
            setsockopt(otherpackages.zmq.ZMQ.ZMQ_SNDTIMEO, value);
        }
        ...
        {
            setsockopt(otherpackages.zmq.ZMQ.ZMQ_TCP_KEEPALIVE, value);
        }
        ...
        {
            return base.getSocketOpt(otherpackages.zmq.ZMQ.ZMQ_TCP_KEEPALIVE);
        }
        ...
        {
            setsockopt(otherpackages.zmq.ZMQ.ZMQ_TCP_KEEPALIVE_CNT, value);
        }
        ...
        {
            return base.getSocketOpt(otherpackages.zmq.ZMQ.ZMQ_TCP_KEEPALIVE_CNT);
        }
        ...
        {
            setsockopt(otherpackages.zmq.ZMQ.ZMQ_TCP_KEEPALIVE_INTVL, value);
        }
        ...
        {
            return base.getSocketOpt(otherpackages.zmq.ZMQ.ZMQ_TCP_KEEPALIVE_INTVL);
        }
        /**
        ...
        {
            setsockopt(otherpackages.zmq.ZMQ.ZMQ_TCP_KEEPALIVE_IDLE, value);
        }
        ...
        {
            return base.getSocketOpt(otherpackages.zmq.ZMQ.ZMQ_TCP_KEEPALIVE_IDLE);
        }
        ...
        {
            return base.getSocketOpt(otherpackages.zmq.ZMQ.ZMQ_SNDBUF);
        }
        ...
        {
            setsockopt(otherpackages.zmq.ZMQ.ZMQ_SNDBUF, (int) value);
        }
        ...
        {
            return base.getSocketOpt(otherpackages.zmq.ZMQ.ZMQ_RCVBUF);
        }
        ...
        {
            setsockopt(otherpackages.zmq.ZMQ.ZMQ_RCVBUF, (int) value);
        }
        ...
        {
            return base.getSocketOpt(otherpackages.zmq.ZMQ.ZMQ_RCVMORE) == 1;
        }
        ...
        {
            return (SelectableChannel) base.getsockoptx(otherpackages.zmq.ZMQ.ZMQ_FD);
        }
        ...
        {
            return base.getSocketOpt(otherpackages.zmq.ZMQ.ZMQ_EVENTS);
        }
        ...
        {
            setsockopt(otherpackages.zmq.ZMQ.ZMQ_SUBSCRIBE, topic);
        }
        ...
        {
            setsockopt(otherpackages.zmq.ZMQ.ZMQ_UNSUBSCRIBE, topic);
        }
        ...
        {
            base.setSocketOpt(otherpackages.zmq.ZMQ.ZMQ_ENCODER, cls);
        }
        ...
        {
            base.setSocketOpt(otherpackages.zmq.ZMQ.ZMQ_DECODER, cls);
        }
        ...
        {
            setsockopt(otherpackages.zmq.ZMQ.ZMQ_ROUTER_MANDATORY, mandatory ? 1 : 0);
        }

        public final void setRouterHandover(boolean handlover)
        {
            setsockopt(otherpackages.zmq.ZMQ.ZMQ_ROUTER_HANDOVER, handlover ? 1 : 0);
        }
        ...
        {
            setsockopt(otherpackages.zmq.ZMQ.ZMQ_XPUB_VERBOSE, verbose ? 1 : 0);
        }
        ...
        {
            return base.getSocketOpt(otherpackages.zmq.ZMQ.ZMQ_IPV4ONLY) == 1;
        }
        ...
        {
            setsockopt(otherpackages.zmq.ZMQ.ZMQ_IPV4ONLY, v4only ? 1 : 0);
        }
        ...
        {
            setsockopt(otherpackages.zmq.ZMQ.ZMQ_TCP_KEEPALIVE, optVal);
        }
        ...
        {
            return base.getSocketOpt(otherpackages.zmq.ZMQ.ZMQ_DELAY_ATTACH_ON_CONNECT) == 1;
        }
        ...
        {
            setsockopt(otherpackages.zmq.ZMQ.ZMQ_DELAY_ATTACH_ON_CONNECT, value ? 1 : 0);
        }
        ...
        {
            return send(data.getBytes(CHARSET), otherpackages.zmq.ZMQ.ZMQ_SNDMORE);
        }
        ...
        {
            return send(data, otherpackages.zmq.ZMQ.ZMQ_SNDMORE);
        }

        public final boolean send(byte[] data, int flags)
        {
            otherpackages.zmq.Msg msg = new otherpackages.zmq.Msg(data);
        ...
        public final boolean send(byte[] data, int off, int length, int flags)
        {
            ...
            otherpackages.zmq.Msg msg = new otherpackages.zmq.Msg(copy);
            if (base.send(msg, flags)) {
                return true;
            }
        ...
        {
            otherpackages.zmq.Msg msg = base.recv(flags);
         ...
         *
         * @param buffer
         *            byte[] to copy otherpackages.zmq message payload in to.
         * @param offset
         ...
         *
         * @param buffer the buffer to copy the otherpackages.zmq message payload into
        ...
        private void mayRaise()
        {
            ...
            if (errno != 0 && errno != otherpackages.zmq.ZError.EAGAIN) {
    ...
    public static class Poller
    {
         ...
         */
        public static final int POLLIN = otherpackages.zmq.ZMQ.ZMQ_POLLIN;
        public static final int POLLOUT = otherpackages.zmq.ZMQ.ZMQ_POLLOUT;
        public static final int POLLERR = otherpackages.zmq.ZMQ.ZMQ_POLLERR;
         ...
         *
         * @param tout
         *            the timeout, as per otherpackages.zmq_poll ();
         ...
         *
         * @see "http://api.zeromq.org/3-0:otherpackages.zmq-poll"
         *
         * @return how many objects where signaled by poll ()
         */
        public int poll(long tout)
        {
            otherpackages.zmq.PollItem[] pollItems = new otherpackages.zmq.PollItem[next];
            for (int i = 0; i < next; i++) {
                pollItems[i] = items[i].base();
            }

            return otherpackages.zmq.ZMQ.poll(pollItems, next, tout);
        }
    ...
    {
        private final otherpackages.zmq.PollItem base;
        private final Socket socket;

        public PollItem(Socket socket, int ops)
        {
            this.socket = socket;
            base = new otherpackages.zmq.PollItem(socket.base, ops);
        }

        public PollItem(SelectableChannel channel, int ops)
        {
            base = new otherpackages.zmq.PollItem(channel, ops);
            socket = null;
        }

        protected final otherpackages.zmq.PollItem base()
        {
            return base;
        }
    ...
    {
        return otherpackages.zmq.ZMQ.proxy(frontend.base, backend.base, null);
    }
    ...
    {
        return otherpackages.zmq.ZMQ.proxy(frontend.base, backend.base, capture != null ? capture.base : null);
    }
    ...
    {
        otherpackages.zmq.PollItem[] pollItems = new otherpackages.zmq.PollItem[count];
        for (int i = 0; i < count; i++) {
            pollItems[i] = items[i].base;
        }

        return otherpackages.zmq.ZMQ.poll(pollItems, count, timeout);
    }
    ...
    {
      return otherpackages.zmq.ZMQ.ZMQ_VERSION_MAJOR;
    }
    ...
    {
      return otherpackages.zmq.ZMQ.ZMQ_VERSION_MINOR;
    }
    ...
    {
      return otherpackages.zmq.ZMQ.ZMQ_VERSION_PATCH;
    }
    ...
    {
        return otherpackages.zmq.ZMQ.makeVersion(otherpackages.zmq.ZMQ.ZMQ_VERSION_MAJOR,
                otherpackages.zmq.ZMQ.ZMQ_VERSION_MINOR,
                otherpackages.zmq.ZMQ.ZMQ_VERSION_PATCH);
    }
    ...
    public static int makeVersion(final int major,
                                    ...
                                    final int patch)
    {
      return otherpackages.zmq.ZMQ.makeVersion(major, minor, patch);
    }
    ...
    public static class Event
    {
        ...
        {
            otherpackages.zmq.ZMQ.Event e = otherpackages.zmq.ZMQ.Event.read(socket.base, flags);
